"""
app.py - Interfaz gráfica de usuario con customtkinter
"""
...
class ScrapRateApp(ctk.CTk):
    ...
    def update_weeks_for_year(self, year):
        ...
        if year < current_year:
            # Año pasado: mostrar todas las 53 semanas
            max_week = 53
        ...
        # Crear lista de semanas (empezando en 1)
    ...
    def generate_weekly_pdf(self):
        ...
        try:
            ...
            if week < 0 or week > 52:
                self.after(0, lambda: messagebox.showerror("Error", "La semana debe estar entre 0 y 52"))
                return
